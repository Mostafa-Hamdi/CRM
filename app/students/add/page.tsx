...
const studentSchema = yup.object().shape({
  ...
  relativeName: yup
    .string()
    .required("Relative/Guardian name is required")
    .min(2, "Name must be at least 2 characters")
    .max(100, "Name must not exceed 100 characters"),
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      {...register("level")}
                      placeholder="e.g., Level 1, Grade 10"
                      className={`w-full bg-gradient-to-r from-gray-50 to-blue-50/50 border-2 ${
              ...
              >
                ...
                {isLoading ? (
                  <>
                    ...
                    <span className="relative z-10">Adding Student...</span>
                  </>
                ) : (
                  <>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                ...
                <li>
                  • Parent/Guardian info is required for emergency contacts
                </li>
                <li>
                  • You can update student details anytime after registration
                </li>
              </ul>
            </div>
          </div>
